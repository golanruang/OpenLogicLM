...
class OpenAIModel:
    ...
    def chat_generate(self, input_string, temperature = 0.0, top_p = 1.0):
    ...
    def prompt_generate(self, input_string, temperature = 0.0, top_p = 1.0):
    ...
    def generate(self, input_string, temperature = 0.0, top_p = 1.0):
        if self.model_name in ['text-davinci-002', 'code-davinci-002', 'text-davinci-003']:
            return self.prompt_generate(input_string, temperature, top_p)
        elif self.model_name in ['gpt-4', 'gpt-3.5-turbo']:
            return self.chat_generate(input_string, temperature, top_p)
        else:
